	...
	useEffect(() => {
	  ...
	  if (!wrap.querySelector('.particle')) {
		  ...
		  for (let i = 0; i < 35; i++) {
			  ...
			  p.style.cssText = `width:${s}px;height:${s}px;left:${Math.random()*300}px;bottom:${Math.random()*30}px;background:${c};box-shadow:0 0 ${s*2}px ${c};animation-duration:${Math.random()*4+3}s;animation-delay:${Math.random()*6}s;`;
	  ...
	  if (!clipGroup || clipGroup.querySelector('.rm')) return;
