  ...
  return (
    <html lang="es">
      <head>
        ...
        {/* Fuentes para el nuevo logo animado */}
        <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@900&family=Montserrat:wght@300&display=swap" rel="stylesheet" />
      </head>
      <body>
        <AuthProvider>
          {children}
